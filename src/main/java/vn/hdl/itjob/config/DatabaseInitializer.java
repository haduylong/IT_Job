...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // init role SUPER_ADMIN with full permission
        if (!this.roleRepository.existsByName("SUPER_ADMIN")) {
            log.info(">>> Create role SUPER_ADMIN");
            List<Permission> permissions = this.permissionRepository.findAll();

            Role role = new Role();
            role.setName("SUPER_ADMIN");
            role.setActive(true);
            role.setDescription("SUPER_ADMIN has full permission");
